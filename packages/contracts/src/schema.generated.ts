...
export const foundationSchema = {
  ...
  "$id": "https://design-studio.invalid/schemas/1.0/foundation.schema.json",
  "title": "FoundationContracts",
  "description": "Authoritative F01 v1 shapes. Validation is not dependency resolution, integrity verification, approval authentication or readiness. See DESIGN_IR.md.",
  "anyOf": [
    {
      "$ref": "#/definitions/DesignIR"
    },
    {
      "$ref": "#/definitions/HandoffManifest"
    },
    {
      "$ref": "#/definitions/ResourceSnapshot"
    },
    {
  ...
  "definitions": {
      ...
      "properties": {
        "binding": {
          ...
          "properties": {
            ...
            "operationId": {
              "type": "string",
              "pattern": "^fork_reference_[a-f0-9]{64}$"
            },
            "projectId": {
              "$ref": "#/definitions/StableId"
            },
    ...
    "ReferenceForkOrigin": {
      ...
      "properties": {
        ...
        "ownership": {
          "const": "origin-evidence-not-destination-authority"
        }
      }
    },
    ...
    "ReferenceRecoveryBinding": {
      ...
      "properties": {
        ...
        "confirmation": {
          "const": "RECOVER-VERIFIED-REFERENCE-OFFLINE"
        }
      }
    },
    "ReferenceRecoveryArchive": {
      ...
      "required": [
        "kind",
        "originBackupSha256",
        "restoredFromBackupSha256",
        "sourceRecordSha256",
        "bindingSha256",
        "currentRecordSha256",
        "currentStateSha256",
        "currentMetadataSha256",
        "protectionSha256",
        "sha256"
      ],
      "properties": {
        "kind": {
          "const": "restored-offline-reference-v1"
        },
        "originBackupSha256": {
          "$ref": "#/definitions/Sha256"
        },
    ...
    "ReferenceRecoveryRecord": {
      ...
      "properties": {
        "archive": {
          "$ref": "#/definitions/ReferenceRecoveryArchive"
        },
        "reservation": {
          "type": "object",
          "additionalProperties": false,
          ...
          "properties": {
            "binding": {
              "$ref": "#/definitions/ReferenceRecoveryBinding"
            },
            "evidence": {
              "$ref": "#/definitions/Artifact"
            }
    ...
    "ReferenceRecoveryEvidence": {
      ...
      "properties": {
        ...
        "kind": {
          "const": "offline-recovered-reference"
        },
        "binding": {
          "$ref": "#/definitions/ReferenceRecoveryBinding"
        },
    ...
    "OfflineReferencePlan": {
      ...
      "properties": {
        ...
        "projectWriteScope": {
          "const": "single-recovery-and-bound-conversion-only"
        },
        "receiptSha256": {
          "$ref": "#/definitions/Sha256"
        },
    ...
    "ReferenceConversionEvidence": {
      ...
      "properties": {
        ...
        "composition": {
          "const": "figma-capture-recovered-reference-v1"
        },
        "policy": {
          "const": "fixed-v2"
        },
        ...
        "effectiveReference": {
          "$ref": "#/definitions/EffectiveReference"
        }
      }
    },
    ...
    "NativeReferenceOfflineEnvelope": {
      ...
      "properties": {
        ...
        "plan": {
          "$ref": "#/definitions/OfflineReferencePlan"
        },
        "effectiveReference": {
          "$ref": "#/definitions/EffectiveReference"
        },
    ...
    "RelativePath": {
      ...
      "minLength": 1,
      "maxLength": 1024,
      "pattern": "^(?!(?:.*\\/)?(?:[Cc][Oo][Nn]|[Pp][Rr][Nn]|[Aa][Uu][Xx]|[Nn][Uu][Ll]|[Cc][Oo][Mm][1-9]|[Ll][Pp][Tt][1-9])(?:\\.|\\/|$))(?!(?:.*\\/)?\\.{1,2}(?:\\/|$))(?!(?:.*\\/)?[^\\/]*[ .](?:\\/|$))[A-Za-z0-9_. -]+(?:\\/[A-Za-z0-9_. -]+)*$",
      "description": "Portable bundle-relative slash path, not a host filesystem path. No drives, traversal, empty segments, percent escapes, ADS or Windows reserved basenames. Host confinement/symlink checks are F04."
    },
    "JsonValue": {
      "anyOf": [
        {
    ...
    "Transform": {
      "description": "Affine local transform [a,b,c,d,tx,ty], x'=ax+cy+tx and y'=bx+dy+ty. Translation is in design units; origin is separate.",
      "type": "object",
      "additionalProperties": false,
      "required": [
        "matrix",
    ...
    "Layout": {
      ...
      "description": "Normalizer in F02 owns defaults; schema validation never inserts them. Numeric dimensions are fixed design units. No percentages or CSS/native fields.",
      "properties": {
        "width": {
    ...
    "Appearance": {
      ...
      "properties": {
        ...
        "blur": {
          "$ref": "#/definitions/Dimension",
          "description": "Representable evidence; outside the initial exact rendering profile."
        },
        "clip": {
    ...
    "StyledRange": {
      ...
      "description": "Zero-based half-open UTF-16 code units; no implicit Unicode normalization. F02 checks order, coverage and surrogate boundaries. Grapheme editing is adapter policy.",
      "properties": {
        "start": {
          "type": "integer",
          "minimum": 0
    ...
    "ContainerNode": {
      ...
      "properties": {
        ...
        "flow": {
          ...
          "description": "Required semantically for frame; row/column/stack have intrinsic direction and group does not allocate layout."
        },
        "appearance": {
    ...
    "ImageNode": {
      ...
      "properties": {
        ...
        "crop": {
          "$ref": "#/definitions/Bounds",
          "description": "Explicit source-pixel crop, distinct from node transform; semantic bounds checks belong to F02/F05."
        },
        "assetTransform": {
          "$ref": "#/definitions/Transform"
        }
    ...
    "DesignNode": {
      "oneOf": [
        ...
        {
          "$ref": "#/definitions/UnsupportedNode"
        }
      ]
    },
    "ResourceLock": {
    ...
    "VisualDefinition": {
      ...
      "properties": {
        ...
        "dependencies": {
          "$ref": "#/definitions/DependencyDeclaration"
        },
        "accessibility": {
          "$ref": "#/definitions/Accessibility"
        },
    ...
    "TargetCodeMapping": {
      ...
      "properties": {
        ...
        "state": {
          "$ref": "#/definitions/MappingState"
        },
        "repository": {
          "$ref": "#/definitions/RepositoryIdentity"
        },
        "path": {
          "$ref": "#/definitions/RelativePath"
        },
    ...
    "ComponentSnapshot": {
      ...
      "properties": {
        ...
        "definitions": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/VisualDefinition"
          }
        },
        "mappings": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/TargetCodeMapping"
          }
        }
      }
    },
    "TokenSnapshot": {
      ...
      "properties": {
        ...
        "resolved": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/TokenResolution"
          }
        },
        "adapters": {
          "type": "array",
    ...
    "ResourceSnapshot": {
      ...
      "properties": {
        ...
        "components": {
          "$ref": "#/definitions/ComponentSnapshot"
        },
        "tokens": {
          "$ref": "#/definitions/TokenSnapshot"
        },
        "assets": {
          "type": "array",
          "items": {
    ...
    "SourceSnapshot": {
      ...
      "properties": {
        ...
        "identity": {
          "$ref": "#/definitions/SourceIdentity"
        },
        "capturedAt": {
          "$ref": "#/definitions/Timestamp"
        },
    ...
    "CaptureRecoveryAuthorization": {
      ...
      "properties": {
        ...
        "proposal": {
          "$ref": "#/definitions/CaptureRecoveryProposal"
        },
        "recordedAt": {
          "$ref": "#/definitions/Timestamp"
        },
        "confirmation": {
          "const": "AUTHORIZE-ONE-CAPTURE-WITH-UNKNOWN-RESPONSE-AND-QUOTA"
        },
        "artifactRootId": {
          "$ref": "#/definitions/StableId"
        },
        ...
        "nextRequest": {
          "$ref": "#/definitions/FigmaCaptureRequest"
        },
        "nextResources": {
          "$ref": "#/definitions/ResourceSnapshot"
        },
        "resourceStates": {
          ...
          "maxItems": 32,
          "items": {
            "$ref": "#/definitions/CaptureRecoveryResource"
          }
        }
      }
    },
    ...
    "ReferenceJobMetadata": {
      ...
      "properties": {
        ...
        "usage": {
          "$ref": "#/definitions/ReferenceJobUsage"
        },
        "effects": {
          "type": "array",
          "maxItems": 1,
    ...
    "ReferenceRecoveryPlan": {
      ...
      "properties": {
        ...
        "eligibility": {
          "const": "eligible-for-recovery-review"
        },
        "consumed": {
          "const": true
        },
      ...
      "properties": {
        ...
        "value": {
          ...
          "properties": {
            ...
            "metadata": {
              "$ref": "#/definitions/ReferenceJobMetadata"
            }
          }
        },
        "error": {
    ...
    "DiagnosticReport": {
      ...
      "properties": {
        ...
        "assessments": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/StageAssessment"
          }
        },
        "diagnostics": {
          "type": "array",
    ...
    "ExpectedBase": {
      ...
      "properties": {
        ...
        "ifMatch": {
          "type": "string",
          "pattern": "^\"[a-f0-9]{64}\"$",
          "description": "Strong quoted ETag of the base content. Both fields must resolve to the same base; F03/F08 enforce atomically."
        }
      }
    },
    "SemanticOperation": {
    ...
    "SemanticPatch": {
      ...
      "properties": {
        ...
        "operations": {
          ...
          "maxItems": 20000,
          "items": {
            "$ref": "#/definitions/SemanticOperation"
          }
        },
        "actorId": {
          "$ref": "#/definitions/StableId"
    ...
    "ReviewEvent": {
      ...
      "properties": {
        ...
        "context": {
          "$ref": "#/definitions/ApprovalContext"
        },
        "actor": {
          "type": "object",
          "additionalProperties": false,
    ...
    "RenderProfile": {
      ...
      "properties": {
        ...
        "renderer": {
          "$ref": "#/definitions/ToolIdentity"
        },
        "browser": {
          "$ref": "#/definitions/ToolIdentity"
        },
        "host": {
          "$ref": "#/definitions/HostIdentity"
        },
        "viewport": {
          "$ref": "#/definitions/Bounds"
        },
    ...
    "CaptureScenario": {
      ...
      "properties": {
        ...
        "requiredControls": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/RequiredControl"
          }
        },
        "locale": {
          "type": "string",
      ...
      "properties": {
        ...
        "screenEvidence": {
          ...
          "properties": {
            ...
            "before": {
              "$ref": "#/definitions/ReadinessReceipt"
            },
            "after": {
              "$ref": "#/definitions/ReadinessReceipt"
            }
    ...
    "ValidationPolicy": {
      ...
      "required": [
        ...
        "calibration",
        "background",
        "maxMaskedAreaFraction",
        "requiredLabelsAndStates",
        "regionDenominator",
        "missingEvidence"
      ],
      "properties": {
        ...
        "pixel": {
          ...
          "properties": {
            "predicate": {
              "const": "max-absolute-srgb-channel-delta"
            },
            "operator": {
              "const": ">"
            },
            "threshold": {
              "const": 0.06274509803921569
            }
          }
        },
        "globalChangedFraction": {
        ...
        "requiredLabelsAndStates": {
          "const": "exact-match-when-measured"
        },
        "regionDenominator": {
          "const": "region-unmasked-pixels"
        },
        "missingEvidence": {
          "const": "inconclusive"
        }
      ...
      "properties": {
        ...
        "regions": {
          ...
          "items": {
            ...
            "properties": {
              "region": {
                "$ref": "#/definitions/ComparisonRegion"
              },
              "status": {
                "enum": [
                  "pass",
    ...
    "HandoffMetadata": {
      ...
      "properties": {
        ...
        "source": {
          "$ref": "#/definitions/SourceSnapshot"
        },
        "provenance": {
          "$ref": "#/definitions/ProvenanceSnapshot"
        },
        "renderProfile": {
    ...
    "HandoffManifest": {
      ...
      "description": "No manifest self-hash; payload artifacts never contain bundleId. Hash canonical payload including sorted artifact hashes, excluding bundleId and volatile delivery metadata only. Integrity is not authorship. F03 trusted store validates approval, F08/later compiler publishes atomically.",
      "properties": {
        "schemaVersion": {
          "$ref": "#/definitions/SchemaVersion"
        },
    ...
    "DeviceScenarioRequest": {
      ...
      "properties": {
        ...
        "scenario": {
          "$ref": "#/definitions/CaptureScenario"
        },
        "runNonce": {
          "$ref": "#/definitions/StableId"
        },
    ...
    "SemanticCase": {
      ...
      "properties": {
        ...
        "evidence": {
          "const": "contract-only-not-executed"
        }
      }
    },
    "FixtureManifest": {
